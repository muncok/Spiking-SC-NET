...
% Initialize net
nn = nnsetup([784 1024 1024 1024 10]);
% Rescale weights for ReLU
nn.W{1, 1} = double(h5read('binary_weights.h5','/dense_55/dense_55_W'));
nn.W{1, 2} = double(h5read('binary_weights.h5','/dense_56/dense_56_W'));
nn.W{1, 3} = double(h5read('binary_weights.h5','/dense_57/dense_57_W'));
nn.W{1, 4} = double(h5read('binary_weights.h5','/dense_58/dense_58_W'));
% for i = 2 : nn.n   
